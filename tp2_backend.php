...
<body>
    ...
    if ($n3 > 10 || $n3 < 2) {
        echo "<p>Ejercicio 3: El número $n3 cumple con las condiciones.</p>";
    } else {
        echo "<p>Ejercicio 3: El número $n3 no cumple con las condiciones.</p>";
    }
    ...
    if ($numero1 > $numero2) {
        ...
        echo "<p>La multiplicación de $numero1 y $numero2 es $multiplicacion, la división es $division_entera y el resto de la división es $resto.</p>";
    } else {
